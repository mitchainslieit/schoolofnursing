                ...
                <ul class="nav navbar-nav mx-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-2 " aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="">Change my Password</a>
                        </div>
                    </li>
                </ul>
                        ...
                        <?php
                            ...
                            while($row = mysqli_fetch_array($result)) {
                                ...
                                echo "<td><form action='scripts/download.php' class='d-inline' method='post' name='download' id='download-link'>
                                        ...
                                        <button class='btn btn-dark my-2' type='submit' name='gosearch' data-toggle='modal' data-target='#updatecv$counter'><i class='fas fa-upload'></i></button>
                                        <div id='updatecv$counter' class='modal fade py-5' role='update'>
                                        <div class='modal-dialog text-left'>
                                            <div class='modal-content add-faculty bg-dark'>
                                                    <form class='' method='post' action='admin.php'>
                                                        <div class='modal-header'>
                                                            <h4 class='modal-title text-white'>Change $row[acc_name]'s CV</h4>
                                                            <button type='button' class='close text-danger' data-dismiss='modal'>&times;</button>
                                                        </div>
                                                        <div class='modal-body'>
                                                            <div class='col-md-12'>
                                                                <input name='idno' value='$row[email]' type='hidden'>
...
<!------------------------------------------------MODALS------------------------------------------------>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <span id="h1-sub">
                        ...
                        <button class='btn btn-dark my-2' type='submit' name='' data-toggle='modal' data-target='#updatecv'><i class='fas fa-upload'></i></button>
                        <form class='d-inline' method='post' action='cv/converter.php'>
                                <?php 
                                    $fact_email = $_SESSION['search_fact_email'];
    ...
    <div id="updatecv" class="modal fade py-5" role="update">
    <div class="modal-dialog text-left">
        <div class="modal-content add-faculty bg-dark">
            <form class="" method="post" action="admin.php">
                <div class="modal-header">
                    <h4 class="modal-title text-white">Change Faculty's CV</h4>
                    <button type="button" class="close text-danger" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="col-md-12">
