        ...
        <div class="col-md-4">
          <div class="card text-white bg-primary p-2">
            <div class="card-body">
                ...
                <span class="">
                    <h2 class="text-center">School of Nursing </h2>
                    <h4 class="mb-4 text-center">Saint Louis University</h4>
                </span>     
                
              <form action="https://formspree.io/YOUREMAILHERE" style="clear: both">
